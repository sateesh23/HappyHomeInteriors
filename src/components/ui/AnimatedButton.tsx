...
export function AnimatedButton({ 
  ...
  const content = (
    <>
      <span className="flex items-center justify-center w-full h-full translate-y-0 group-hover:-translate-y-12 group-hover:opacity-0 transition-all duration-300">
        {text}
      </span>
  ...
  const baseClasses = `group relative inline-flex cursor-pointer border-2 border-[#EA580C] bg-[#EA580C] rounded-xl overflow-hidden text-white text-center text-[15px] font-semibold whitespace-nowrap shadow-[0_4px_14px_rgba(234,88,12,0.2)] hover:shadow-[0_6px_20px_rgba(234,88,12,0.3)] active:scale-95 transition-all duration-300 px-6 py-3 ${className}`;
