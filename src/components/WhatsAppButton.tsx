...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center bg-[#25D366] text-white rounded-md shadow-2xl border border-white/20 h-14 overflow-hidden transition-all duration-300 ease-in-out hover:shadow-[0_8px_32px_rgba(37,211,102,0.4)]"
      style={{ width: hovered ? "168px" : "56px" }}
    ...
    >
      ...
      {/* Label */}
      <span
        className="whitespace-nowrap font-bold text-sm pr-4 tracking-tight"
        style={{
          opacity: hovered ? 1 : 0,
